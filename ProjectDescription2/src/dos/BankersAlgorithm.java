...
public class BankersAlgorithm {
    ...
    // method to cheking safe state
    public boolean isSafeState() {
        int[] work = Arrays.copyOf((available), numOfProcesses);
